package com.cyberia.radio.slidingpanel;
...
public class SlidingUpPanelLayout extends ViewGroup {
     ...
     */
    private static final int DEFAULT_PANEL_HEIGHT = 60; // dp;
...
//            Log.d(TAG, "View is settling. Aborting animation.");
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        boolean result;
        final int save = canvas.saveLayer(0,0,canvas.getWidth(),canvas.getHeight(),null);
